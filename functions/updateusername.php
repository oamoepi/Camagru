...
<html>
    ...
    <body>
            ...
            <div class="container">
                ...
                <nav>
                    <ul>
                        ...
                        <li class="current"><a href="updateemail.php">Settings</a></li>
                    </ul>
                </nav>
        ...
        <section id="main">
            <div class="container">
                <article id="main-col">
                <h2 class="page-title">You can use the same EMAIL to proceed from this step</h2>
...
All captured images should be public, likeables and commentable.</p>
                ...
                <aside id="sidebar">
                    <div class="dark">
                      ...
                      <form class="quote" action="updatedetails.php" method="POST">
                        <div>
			        	<label>Username</label><br>
                            <input type="text" name=updatesent placeholder="Username">
                        </div>
                        <div>
			        	<label>Email</label><br>
                            <input type="email" name="email" placeholder="Email address">
                        </div>
                        <button class="button_1" type="submit" name="updatesent">Send</button>
			        </form>
                    </div>
                </aside>
            </div>
